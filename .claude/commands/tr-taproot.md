...
When running taproot commands in this project, replace bare `taproot` with: `./taproot/agent/bin/taproot`
Example: `./taproot/agent/bin/taproot dod taproot/some-intent/some-behaviour/impl-name/impl.md`
